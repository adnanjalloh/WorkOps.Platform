...
namespace WorkOps.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260911162012_WorkItemListingIndexes")]
    partial class WorkItemListingIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WorkOps.Domain.Audit.AuditEvent", b =>
                {
                    ...
                    b.HasAnnotation("WorkOps:TenantIdProperty", "WorkspaceId");
                });
            ...
            modelBuilder.Entity("WorkOps.Domain.Tenancy.Workspace", b =>
                {
                    ...
                    b.HasAnnotation("WorkOps:TenantIdProperty", "Id");
                });
            ...
            modelBuilder.Entity("WorkOps.Domain.WorkItems.WorkItem", b =>
                {
                    ...
                    b.HasIndex("WorkspaceId", "ProjectId", "CreatedAt", "Id")
